          ...
          <div class="menus">
            <div class="item active mb-30">
              ...
              <p class="item-title m-0">
                <a href="" class="text-lg text-decoration-none">
                  Overview
                </a>
              </p>
            </div>
          ...
          <div class="sidebar-footer pt-73 pe-30">
            <div class="footer-card">
              <div class="d-flex justify-content-between mb-20">
                ...
                <p class="fw-medium color-palette-1">
                  Top Up &<br />
                  Be The Winner
                </p>
              </div>
              <a
                class="btn btn-get-started w-100 fw-medium text-xs text-center text-white rounded-pill"
                href="#"
                role="button"
              >
                Get Started
