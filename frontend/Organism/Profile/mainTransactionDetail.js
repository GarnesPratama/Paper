...
export default function mainTransactionDetail() {
  return (
    <div>
            ...
            <div class="main-content main-content-card overflow-auto">
              <section class="checkout mx-auto">
                <div class="d-flex flex-row  align-items-center justify-content-between mb-30">
                  ...
                  <div>
                    <p class="fw-medium text-center label pending m-0 rounded-pill">
                      Pending
                    </p>
                  </div>
                </div>
                ...
                <div class="d-md-block d-flex flex-column w-100">
                  <a
                    class="btn btn-whatsapp rounded-pill fw-medium text-white border-0 text-lg"
                    href="#"
                    role="button"
                  >
                    WhatsApp ke Admin
