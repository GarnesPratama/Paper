      ...
      <main class="main-wrapper">
        <div class="ps-lg-0">
          ...
          <div class="top-up-categories mb-30">
            <p class="text-lg fw-medium color-palette-1 mb-14">
              Top Up Categories
            </p>
                ...
                <div class="col-lg-4 ps-15 pe-15 pb-lg-0 pb-4">
                  <div class="categories-card">
                    <div class="d-flex align-items-center mb-24">
                      ...
                      <p class="color-palette-1 mb-0 ms-12">
                        Game
                        <br /> Desktop
                      </p>
                    </div>
                    <div>
                      ...
                      <p class="text-2xl color-palette-1 fw-medium m-0">
                        Rp 18.000.500
                      </p>
                    </div>
                  </div>
              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  <tr class="align-middle">
                    <th scope="row">
                      <img
                        class="float-start me-3 mb-lg-0 mb-3"
                      ...
                      <div class="game-title-header">
                        <p class="game-title fw-medium text-start color-palette-1 m-0">
                          Mobile Legends: The New Battle 2021
                        </p>
                        <p class="text-xs fw-normal text-start color-palette-2 m-0">
                          Desktop
                        </p>
                      </div>
                    </th>
                    ...
                    <td>
                      <p class="fw-medium text-start color-palette-1 m-0">
                        Rp 290.000
                      </p>
                    </td>
                    <td>
